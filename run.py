...
def get_sales_data():
    ...
    Run the while loop to collect a valid string of data from the user
    via the terminal, which must be a string of 6 numbers separated
    by commas. the loop will repeatedely request data, until it is valid.
    """
    while True:
...
Refactoring mean that both where merged into the function
called update_worksheet
